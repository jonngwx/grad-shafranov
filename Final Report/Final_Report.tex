...
\frac{1}{R} \left(\frac{\Psi(R + dR, Z) - \Psi(R - dR, Z)}{2dR} \right) + \left( \frac{\Psi (R + dR, Z) - 2\Psi(R,Z) + \Psi(R-dR, Z)}{dR^2} \right) \\ + \left(\frac{\Psi(R, Z + dZ) - 2\Psi(R,Z)  + \Psi(R, Z-dZ)}{dZ^2}\right) = \mu_o R J_{\phi}(R,Z). 
\end{multline}
...
\Psi^{n+1}_{i,j} = -\frac{dr^2 dz^2}{2dz^2 + 2dr^2} \left( \mu_o R J^n_{\phi \, i, j} + (2 R dr - \frac{1}{dr^2})^{-1} \Psi^{n}_{i+1,j} - (2 R dr - \frac{1}{dr^2})^{-1} \Psi^{n+1}_{i-1,j} - \frac{1}{dz^2} \right) \Psi^{n+1}_{i,j-1} \\ - \frac{1}{dz^2}\Psi^n_{i, j+1}. 
\end{multline}
...
\Psi^{n+1}_{i,j} = (1-\omega)\Psi^n_{i,j} -\frac{\omega dr^2 dz^2}{2dz^2 + 2dr^2} \left( \mu_o R J^n_{\phi \, i, j} + (2 R dr - \frac{1}{dr^2})^{-1} \Psi^{n}_{i+1,j} - (2 R dr - \frac{1}{dr^2})^{-1} \Psi^{n+1}_{i-1,j} - \frac{1}{dz^2} \right) \Psi^{n+1}_{i,j-1} \\ - \frac{1}{dz^2}\Psi^n_{i, j+1}
\end{multline}
